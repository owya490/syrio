...
export default function EventBookingPanelModule({
  ...
  return (
    <div
      className={`border border-syrio-white/40 bg-syrio-black/50 p-5 sm:p-6 rounded-lg space-y-6 min-w-0 w-full ${className}`}
    >
      <h3 className="font-bank-gothic text-xl uppercase tracking-widest text-syrio-white break-words">
      ...
      <div className="space-y-5">
        ...
        <EventInfoRow
          ...
          value={
            <a
              ...
              className="hover:text-syrio-pink transition-colors break-words"
            >
              {event.location}
            </a>
          }
        ...
        <EventInfoRow
          ...
          label={eventMessages.booking.labels.availability}
          value={vacancyText}
        />
