      ...
      <div className="grid grid-cols-1 gap-12 lg:grid-cols-2 lg:items-center lg:gap-24">
        ...
        >
          ...
          <div className="absolute right-0 top-0 h-4/5 w-3/4 rotate-6 transform overflow-hidden rounded-lg shadow-xl transition-transform duration-500 hover:rotate-3">
            <div className="relative h-full w-full bg-gray-200">
              <Image
                src={images.main}
                alt={sharedMessages.contentBlocks.mainVisualAlt}
                fill
        ...
        <Reveal direction="right" delay={1}>
          <div className="flex flex-col justify-center space-y-8">
            ...
            <Reveal delay={3} className="space-y-4 md:space-y-6">
              <ul className="space-y-4 md:space-y-6">
                {features.map((feature, index) => (
                  <Reveal
                    ...
                    distance={20}
                  >
                    <li className="font-montserrat text-sm md:text-base font-bold tracking-wide text-gray-800">
                      {feature}
                    </li>
                  </Reveal>
                ))}
