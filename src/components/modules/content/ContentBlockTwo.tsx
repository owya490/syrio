    ...
    >
      <div className="grid grid-cols-1 gap-12 lg:grid-cols-12 lg:gap-8">
        ...
        <div className="flex flex-col justify-between space-y-8 lg:col-span-4 lg:space-y-16 order-2 lg:order-1">
          ...
          <div className="relative aspect-[4/5] w-full overflow-hidden rounded-sm border border-white/10 shadow-2xl lg:w-4/5 hidden md:block">
            <Image
        ...
        <div className="flex md:pt-20 items-start lg:col-span-8 lg:pl-6 order-1 lg:order-2 -mt-8 lg:-mt-12">
